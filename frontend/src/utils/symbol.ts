...
export const IID_TO_SYMBOL: Map<string, Symbol> = new Map([
    ...
    ["buffing_capsule", Symbol.BuffingCapsule],
    ["candy", Symbol.Candy],
    ...
    ["hustling_capsule", Symbol.HustlingCapsule],
