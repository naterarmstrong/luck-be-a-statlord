...
export const billionaire = require("../img/billionaire.png");
...
export const IID_TO_SYMBOL: Map<string, Symbol> = new Map([
    ...
    ["lucky_capsule", Symbol.WealthyCapsule],
...
export const SYMBOL_TO_IMG: Map<Symbol, string> = new Map([
    ...
    [Symbol.MatryoshkaDoll2, matryoshka_doll_2],
    [Symbol.MatryoshkaDoll3, matryoshka_doll_3],
    [Symbol.MatryoshkaDoll4, matryoshka_doll_4],
    [Symbol.MatryoshkaDoll5, matryoshka_doll_5],
