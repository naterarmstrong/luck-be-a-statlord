...
const columns: GridColDef[] = [
    ...
    renderCell: (params: any) => (
      <Box>
        <Box
          component="img"
          style={{ width: "50px" }}
          src={SYMBOL_TO_IMG.get(params.value)}
        />
  ...
  },
  {
    ...
    renderCell: (params: any) => {
      return (
        <Box sx={{ color: rarityColor(params.value) }}>{params.value}</Box>
      );
    },
  },
  ...
  { field: "total_games", headerName: "Total Games", minWidth: 150 },
  {
    ...
    minWidth: 150,
    valueGetter: (params: GridValueGetterParams) => params.row.chosen_games,
  },
  {
    ...
    valueGetter: (params: GridValueGetterParams) =>
      ((100 * params.row.chosen_won_games) / params.row.chosen_games).toFixed(
        2,
      ),
  },
