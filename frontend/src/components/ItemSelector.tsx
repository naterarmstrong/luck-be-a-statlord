...
const ItemSelector: React.FC<ItemSelectorProps> = ({ item, setItem, essence }) => {
    return <Autocomplete
        disablePortal
        autoComplete
        disableClearable
        options={Object.keys(Item).filter((i) => essence ? ITEM_RARITIES[i as Item] === Rarity.Essence : ITEM_RARITIES[i as Item] !== Rarity.Essence)}
        value={item}
