      ...
      <Container maxWidth="xl">
        <Toolbar>
          ...
          <Link href="/essenceStats" sx={{ mr: 2, ml: 2 }}>
            <Typography variant="h6">Essences</Typography>
          </Link>
          <Link
            onClick={handleClick}
            sx={{ mr: 2, ml: 2, textShadow: "inherit" }}
            component="button"
          >
          ...
          >
            ...
            <MenuItem
              onClick={() => {
                handleClose();
                navigate("/purplePepperCalculator");
              }}
            >
              <SymImg
                tile={Item.PurplePepper}
                omitTooltip
                style={{ marginRight: 2 }}
              />{" "}
