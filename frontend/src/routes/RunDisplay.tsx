...
const RunDisplay: React.FC = () => {
    ...
    testSymbols.push(...[Symbol.ShinyPebble, Symbol.Dud, Symbol.RabbitFluff, Symbol.Flower, Symbol.Empty]);
    testSymbols.push(...[Symbol.Sun, Symbol.Rabbit, Symbol.RabbitFluff, Symbol.Flower, Symbol.Empty])
    testSymbols.push(...[Symbol.Sun, Symbol.FiveSidedDie, Symbol.RabbitFluff, Symbol.Empty, Symbol.Empty])
