...
const Profile: React.FC = () => {
  ...
  return (
    <Grid container alignItems="center" justifyContent="center">
      ...
      <Grid item xs={8}>
        <Typography variant="h5">Winrate Details</Typography>
      </Grid>
      <Grid item xs={4} alignSelf="start">
        <Typography variant="h3">
          <Box
            ...
            src={SYMBOL_TO_IMG.get(Symbol.Billionaire)}
          />
          {name}
        </Typography>
        {stats
        ...
        {stats
          ? standardCard(
              "Landlord Executions",
              `${stats.guillotines}`,
              `Only includes floor 20 executions`,
            )
          : null}
      </Grid>
            ...
            {stats ? (
              <Card sx={{ mb: 1, ml: 3, mr: 3 }}>
                <CardContent>
                  ...
                  <Typography
                    sx={{ display: "inline-block", mx: "50px" }}
                    color="text.secondary"
                  >
                    Over last 300 games
                  </Typography>
