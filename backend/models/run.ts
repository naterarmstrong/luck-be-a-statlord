...
export const Run = sequelize.define(
  "Run",
  {
    hash: {
...
export const SymbolDetails = sequelize.define(
  "SymbolDetails",
  {
    symbol: {
      type: DataTypes.STRING,
...
export const ItemDetails = sequelize.define(
  "ItemDetails",
  {
    item: {
      type: DataTypes.STRING,
...
export const SymbolDetailsByRent = sequelize.define(
  "SymbolDetailsByRent",
  {
    symbol: {
      type: DataTypes.STRING,
...
export const ItemDetailsByRent = sequelize.define(
  "ItemDetailsByRent",
  {
    item: {
      type: DataTypes.STRING,
...
export const Spin = sequelize.define(
  "Spin",
  {
